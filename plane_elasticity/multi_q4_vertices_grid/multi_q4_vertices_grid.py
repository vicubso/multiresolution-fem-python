...
from ..multi_q4_vertices import MultiQ4Vertices

class MultiQ4VerticesGrid:
    """
    ...
    def draw(self, u, E, axs=plt, draw_subelements=False, ml_condensation=False):
        ...
        if draw_subelements:
            elements = [None] * self.n_elm # Array of n_elm MultiQ4Vertices() objects # TODO: not sure if needed
